...
open_quizz_db_data = (
    ("Cinema", "Bruce Willis", "https://www.kiwime.com/oqdb/files/1046489895/OpenQuizzDB_046/openquizzdb_46.json"),
    ("Bande dessinnée", "Tintin", "https://www.kiwime.com/oqdb/files/2124242395/OpenQuizzDB_124/openquizzdb_124.json"),
    ("Télévision", "Star Trek", "https://www.kiwime.com/oqdb/files/1018823294/OpenQuizzDB_018/openquizzdb_18.json"),
    ("Vie quotidienne", "Chocolat", "https://www.kiwime.com/oqdb/files/1019656546/OpenQuizzDB_019/openquizzdb_19.json"),
)
...
def generate_json_file(categorie, titre, url):
    ...
    try:
        ...
        try:
            ...
            print(f"Exception dans la deserialisation ou l'utilisation des données (questionnaire : {titre}, url: {url})")
